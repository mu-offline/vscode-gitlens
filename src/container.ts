...
export class Container {
	...
	static get github() {
		if (!this.config.githubToken) return undefined;
	...
	private static async _loadGitHubApi() {
		const github = new (await import(/* webpackChunkName: "github" */ './github/github')).GitHubApi();
		this._context.subscriptions.push(github);
